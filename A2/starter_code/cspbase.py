...
class Variable: 
    ...
    #
    def __init__(self, name, domain=[]): # Instantiate Variable: (name, domain, current domain flags, assigned value)
    ...
    def add_domain_values(self, values): # Add additional domain values to the domain
    ...
    def domain_size(self): # Return the size of the (permanent) domain
        '''Return the size of the (permanent) domain'''
        return(len(self.dom))

    def domain(self): # Return the variable's (permanent) domain in list form
    ...
    def prune_value(self, value): # Set flag for the value to False in the CURRENT domain flags
        '''Remove value from CURRENT domain'''
        self.curdom[self.value_index(value)] = False

    def unprune_value(self, value): # Set flag for the value to True in the CURRENT domain flags
        '''Restore value to CURRENT domain'''
        self.curdom[self.value_index(value)] = True

    def cur_domain(self): # Return list of values in CURRENT domain (if assigned only assigned value is viewed)
    ...
    def in_cur_domain(self, value): # Check if value is in CURRENT domain (if assigned only assigned value is viewed)
    ...
    def cur_domain_size(self): # Return the size of the CURRENT domain
    ...
    def restore_curdom(self): # Restore all values back into CURRENT domain
    ...
    def is_assigned(self): # Check if the variable is assigned
        return self.assignedValue != None
    
    def assign(self, value): # Assign a value to the variable, if not already assigned or value not in the CURRENT domain
    ...
    def unassign(self): # Unassign the variable, if it is assigned
    ...
    def get_assigned_value(self): # Return the assigned value (if assigned)
    ...
    def value_index(self, value): # Return the index of the value in the domain
        '''Domain values need not be numbers, so return the index
           in the domain list of a variable value'''
        return self.dom.index(value)

    def __repr__(self): # Return the name of the variable
        return("Var-{}".format(self.name))

    def __str__(self): # Return the name of the variable
        return("Var--{}".format(self.name))

    def print_all(self): # Print the name, domain, and CURRENT domain of the variable
...
class Constraint: 
    ...
    def __init__(self, name, scope): # Instantiate Constraint: (name, scope, satisfying tuples, supporting tuples)
    ...
    def add_satisfying_tuples(self, tuples): # Add satisfying assignmen (tuple t) within the scope of the constraint
                                                # Then for each variable value pair in each satisfying assignment (tuple t),
                                                # add the satisfying assignment (tuple t) as a support for that variable value pair
